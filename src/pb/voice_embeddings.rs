...
pub struct VoiceEmbeddingRequest {
    /// Request ID
    #[prost(string, tag = "1")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VoiceEmbeddingResponse {
    /// Request ID (same as in the request)
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    /// Embedding vector (dimension 192)
...
pub mod embedding_server {
    ...
    pub trait Embedding: std::marker::Send + std::marker::Sync + 'static {
        async fn embed_voice(
            &self,
            request: tonic::Request<super::VoiceEmbeddingRequest>,
        ) -> std::result::Result<
            tonic::Response<super::VoiceEmbeddingResponse>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/voice_embeddings.Embedding/EmbedVoice" => {
                    #[allow(non_camel_case_types)]
                    struct EmbedVoiceSvc<T: Embedding>(pub Arc<T>);
                    impl<
                        T: Embedding,
                    > tonic::server::UnaryService<super::VoiceEmbeddingRequest>
                    for EmbedVoiceSvc<T> {
                        type Response = super::VoiceEmbeddingResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Embedding>::embed_voice(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = EmbedVoiceSvc(inner);
    ...
    pub const SERVICE_NAME: &str = "voice_embeddings.Embedding";
